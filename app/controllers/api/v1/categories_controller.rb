    ...
    class CategoriesController < BaseController
      def_param_group :category do
        param :category, Hash, desc: 'category parameters', required: true do
          ...
          param :is_active, :boolean, desc: 'Category is active or not. Default is active', required: false
        end
      end
      ...
      def index
        ...
        return render json: CategoryBlueprint.render(categories, root: :categories)
      end
