    ...
    class SubCategoriesController < BaseController
      def_param_group :sub_category do
        param :sub_category, Hash, desc: 'sub_category parameters', required: true do
          ...
          param :is_active, :boolean, desc: 'sub_category is active or not. Default is active', required: false
        end
      end
      ...
      def index
        ...
        return render json: SubCategoryBlueprint.render(sub_categories, root: :sub_categories)
      end
